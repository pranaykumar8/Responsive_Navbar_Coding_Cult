...
function Home() {
  const [heading, setHeading] = useState("Welcome to the Hub Portal");
  const [description, setDescription] = useState(
    "Your one-stop platform to manage job listings, connect with talent, and streamline your recruitment process — all in one place."
  );

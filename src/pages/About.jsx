...
function About() {
  ...
  const [description, setDescription] = useState(
    "We are a leading platform connecting talents with opportunities. Our mission is to simplify hiring and job seeking."
  );
        ...
        <div className="bg-white bg-opacity-90 rounded-xl shadow-xl p-8 max-w-md text-center">
          {isEditing ? (
            <>
              <input
                type="text"
                className="font-bold mb-2 text-5xl w-full bg-transparent text-center border-b border-gray-300 focus:outline-none focus:border-blue-500"
                value={heading}
            ...
            <>
              <h1 className="font-bold mb-2 text-5xl">{heading}</h1>
